...
- [x] 1. Extend AnalysisBundle dataclass and load_analysis_bundle() in stock_analysis_engine.py
  ...
  - [x] 1.1 Write property test for ATR floor (Property 3)
...
- [x] 2. Implement compute_trade_setup() and build_timeframe_signals() pure functions
  ...
  - [x] 2.1 Write property test for Trade Setup Ordering Invariant (Property 1)
  ...
  - [x] 2.2 Write property test for Trade Setup Arithmetic Invariant (Property 2)
  ...
  - [x] 2.3 Write property test for Timeframe Signal Validity (Property 4)
...
- [x] 4. Implement render_price_overview() panel
...
- [x] 5. Implement render_technical_chart() panel
...
- [x] 6. Implement render_multi_timeframe() panel
...
- [x] 7. Implement render_ml_predictions() panel
  ...
  - [x] 7.1 Write property test for ML Prediction Direction Validity (Property 9)
...
- [x] 8. Implement render_risk_metrics() panel
  ...
  - [x] 8.1 Write property test for Risk Metrics Non-Negativity (Property 8)
    - **Property 8: Risk Metrics Non-Negativity**
    - Assert `volatility_annual >= 0` for any price series with >= 30 rows
    - **Validates: Requirements 7.4**

- [x] 9. Implement render_monte_carlo() panel
  ...
  - [x] 9.1 Write property test for Monte Carlo Probability Bounds (Property 6)
...
- [x] 10. Implement render_multi_analyzer_scorecard() panel
  ...
  - [x] 10.1 Write property test for Multi-Analyzer Score and Signal Validity (Property 5)
...
- [x] 11. Implement render_global_factors() panel
  ...
  - [x] 11.1 Write property test for Global Factor Structure Invariant (Property 10)
...
- [x] 12. Implement render_trade_setup() panel
...
- [x] 13. Implement load_peer_data() and render_peer_comparison() panel
  ...
  - [x] 13.1 Write property test for Peer Comparison Target Invariant (Property 7)
