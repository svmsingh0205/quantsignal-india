...
# ══════════════════════════════════════════════════════════════════════════════
# PENNY STOCKS (price ≤ ₹50, liquid, NSE-listed)
# ══════════════════════════════════════════════════════════════════════════════
_PENNY = [
    # PSU Banks / Finance
    ...
    "TINPLATE","WELCORP","JINDALSAW","APLAPOLLO",
    # Telecom / Tech
    "GTLINFRA","ONMOBILE","HFCL","STLTECH","RAILTEL","ROUTE","TANLA",
    # Pharma / Healthcare
    "LALPATHLAB","KRSNAA","VIJAYA","THYROCARE","BIOCON","STRIDES","SEQUENT",
    "WOCKPHARMA","BLISSGVS","HIKAL","SOLARA",
    # FMCG / Consumer
    ...
    # Defence / Aerospace
    "DPSL","ZENTEC","PARAS","ASTRA","IDEAFORGE",
    # Misc high-volume penny
    "TRIDENT","DELTACORP","SPENCERS","V2RETAIL","GTLINFRA","SMCGLOBAL",
